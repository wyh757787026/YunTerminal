...
import { Activity, Bot, Film, PanelBottom, Settings, Zap } from 'lucide-react'
import { RecordingButton } from '@renderer/components/recording/RecordingButton'
import { RecordingsDialog } from '@renderer/components/recording/RecordingsDialog'
    ...
    <>
      <div className="status-bar">
        ...
        <div className="flex items-center gap-1">
          ...
          <RecordingButton variant="status" />
          <button
            type="button"
      ...
      {recordingsOpen && <RecordingsDialog onClose={() => setRecordingsOpen(false)} />}
    </>
  )
}
